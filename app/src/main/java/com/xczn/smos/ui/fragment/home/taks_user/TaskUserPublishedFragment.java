 ...
 * Date on 2018/6/6.
 */
public class TaskUserPublishedFragment extends ViewPagerFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static TaskUserPublishedFragment newInstance() {
        return new TaskUserPublishedFragment();
    }
