...
public class TaskRefusedFragment extends SupportFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static TaskRefusedFragment newInstance() {
        return new TaskRefusedFragment();
    }
