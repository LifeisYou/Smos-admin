 ...
 */
public class TopBarTab extends FrameLayout {
    ...
    public TopBarTab(Context context, CharSequence title) {
        this(context, null, title);
    }

    public TopBarTab(Context context, AttributeSet attrs, CharSequence title) {
        this(context, attrs, 0, title);
    }

    public TopBarTab(Context context, AttributeSet attrs, int defStyleAttr, CharSequence title) {
