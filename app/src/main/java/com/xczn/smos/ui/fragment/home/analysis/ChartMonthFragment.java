 ...
 * 日报表Fragment
 */
public class ChartMonthFragment extends BaseBackFragment {

    public static final String TAG = ChartMonthFragment.class.getName();
    ...
    private String selectMonth = TimeUtils.getCurrentMonth();
    private int equipment2Id = 0;

    public static ChartMonthFragment newInstance() {
    ...
    private void initView(View view) {
        ...
        btnSelectDay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SelectMonthFragment fragment = new SelectMonthFragment();
                fragment.show(ft, "select_month");
            }
        });
        ...
        ChartUtils.initMonthLineChart(LI_LineChart, "线电流");
        //相电流
        PI_LineChart = view.findViewById(R.id.PI_LineChart);
        ChartUtils.initMonthLineChart(PI_LineChart, "相电流");

        //线电压
        LU_LineChart = view.findViewById(R.id.LU_LineChart);
        ChartUtils.initMonthLineChart(LU_LineChart, "线电压");
        //相电压
        PU_LineChart = view.findViewById(R.id.PU_LineChart);
        ChartUtils.initMonthLineChart(PU_LineChart, "相电压");
        //系数
        P_LineChart = view.findViewById(R.id.P_LineChart);
        ChartUtils.initMonthLineChart(P_LineChart, "系数");
        //电度
        K_LineChart = view.findViewById(R.id.K_LineChart);
        ChartUtils.initMonthLineChart(K_LineChart, "电度");
    }
...
//                Toast.makeText(_mActivity, equipmentsList.get(i).getEquipment_name()+"+"+equipmentsList.get(i).getEquipment_id(), Toast.LENGTH_SHORT).show();
    ...
    private void initCharts(){
        Log.d(TAG, "initCharts: " + "请求月报表数据");
        HttpMethods.getRetrofit().create(ChartService.class)
                .getChartData(Chart.Time_MONTH, equipment2Id, Chart.MeaType_IA, selectMonth)
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    public void selectDay(DateEvent event){
        if ("month".equals(event.getType())){
            selectMonth = event.getDate();
            btnSelectDay.setText(selectMonth);
            initCharts();
        }
    }
