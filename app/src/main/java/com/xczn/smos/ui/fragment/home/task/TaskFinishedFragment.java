...
public class TaskFinishedFragment extends SupportFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static TaskFinishedFragment newInstance() {
        return new TaskFinishedFragment();
    }
